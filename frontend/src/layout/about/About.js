...
const About = () => {
    ...
    const p1 = "Are you ready to embark on your next adventure, but tired of juggling among Google Maps, TripAdvisor, Wikipedia, and a myriad of other sites to piece together your itinerary? Say hello to CitiXplorer!";
